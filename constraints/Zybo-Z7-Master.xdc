...
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { on }]; IO_L9P_T1_DQS_34 Sch=on
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { lRB }]; IO_L23P_T3_35 Sch=lRB
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { lRF }]; IO_L23N_T3_35 Sch=lRF
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { lLF }]; IO_0_35 Sch=lLF
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { lLB }]; IO_L3N_T0_DQS_AD1N_35 Sch=lLB
...
##RGB LED 6
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { lcerca }]; IO_L18P_T2_34 Sch=lcerca
...
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { LB }]; IO_L10P_T1_34 Sch=LB  			 
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { RF }]; IO_L10N_T1_34 Sch=RF		     
...
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports { LF }]; IO_L8P_T1_34 Sch=LF              
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { RB }]; IO_L8N_T1_34 Sch=RB              
...
##Pmod Header JD                                                                                                                  
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { echo }]; IO_L5P_T0_34 Sch=echo                  
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { trigger }]; IO_L5N_T0_34 Sch=trigger				 
...
##Pmod Header JE                                                                                                                  
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { AA }]; IO_L4P_T0_34 Sch=AA			 
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { AB }]; IO_L18N_T2_34 Sch=AB                     
...
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { BA }]; IO_L3N_T0_DQS_34 Sch=BA                  
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { BB }]; IO_L9N_T1_DQS_34 Sch=BB                  
